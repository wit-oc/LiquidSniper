...
- 2026-03-07 v6.2.5 width-governance patch: made width pass use mode-consistent `widthLimit` (strict/soft/off), added flip-qualified width grace (`flipWidthGracePct/ATR`), and expanded probe width diagnostics (`W fin/cap/soft/lim`, guard-hit count).
