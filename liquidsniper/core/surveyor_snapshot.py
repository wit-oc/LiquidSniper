...
from IntradayTrading.engine.dynamic_levels import build_dynamic_level_packet
from IntradayTrading.engine.fib_anchors import (
...
from IntradayTrading.engine.fib_context import FibConfig, FibTimeframe, aggregate_fib_context, compute_timeframe_state
from IntradayTrading.engine.phase1_contract import PHASE1_STRUCTURE_PROFILE_CANONICAL
from IntradayTrading.engine.surveyor_packet import (
...
from IntradayTrading.engine.zones import Zone, ZoneKind
...
def build_surveyor_packet_snapshot(
    ...
    *,
    ...
    packet["meta"]["ui_source"] = "LiquidSniper/liquidsniper/web/app.py"
